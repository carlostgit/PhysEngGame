 ...
 * @author Carlos
 */
public class PhysEngMIDlet extends MIDlet implements CommandListener  {
    ...
    /**
     * The PhysEngMIDlet constructor.
     */
    public PhysEngMIDlet() {
    }
...
//GEN-LINE:|0-initialize|1|0-postInitialize
    ...
    public void startMIDlet() {//GEN-END:|3-startMIDlet|0|3-preAction
        ...
        PhysEngRunnableGameCanvas pruebasGameCanvas=new PhysEngRunnableGameCanvas(false,display);
        
        display.setCurrent(pruebasGameCanvas);
        new Thread(pruebasGameCanvas).start();
