 ...
 * @author Carlos
 */
public class CIntroductionScreen implements IKeyPressedAndReleasedListener{
     ...
     public CIntroductionScreen(PhysEngRunnableGameCanvas pPhysEngRunnableGameCanvas,CSceneControl pSceneControl){
     ...
     public void run(){
         ...
         m_pPhysEngRunnableGameCanvas.write(m_pPhysEngRunnableGameCanvas.getHeight()/2, new String("This is the introduction screen. Press any key to continue"));
         m_lCount++;
...
//             m_pSceneControl.setState(CSceneControl.MENU_SCREEN);
     ...
     public void drawBackground(){
        m_pPhysEngRunnableGameCanvas.m_g.setColor(0, 0, 100);
     ...
     public void keyPressedAndReleased(int keyCode){ 
         if(m_lCount>20){
             if(m_pSceneControl.getState()==CSceneControl.INTRODUCTION_SCREEN)
             {
                m_bIsFinished=true;                
