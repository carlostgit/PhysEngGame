 ...
 * @author Carlos
 */
public class CImmobilePolygon extends CPolygon {


    public CImmobilePolygon(PhysEngRunnableGameCanvas pPruebasGameCanvas){
    ...
    public CImmobilePolygon(PhysEngRunnableGameCanvas pPruebasGameCanvas, float fX, float fY, float fVx, float fVy, int lSize, float fDegreesTurned, float fVAngular, float fMass){
        super(pPruebasGameCanvas, fX, fY, fVx, fVy, lSize, fDegreesTurned, fVAngular, fMass);
        m_fMass=Float.MAX_VALUE;
        m_fMomentOfInertia=Float.MAX_VALUE;
        m_bImmobile=true;
    ...
    public CImmobilePolygon(PhysEngRunnableGameCanvas pPruebasGameCanvas, float fX1, float fY1, float fX2, float fY2, float fX3, float fY3, int lR, int lG, int lB){
        super(pPruebasGameCanvas, fX1, fY1, fX2,fY2,fX3,fY3,lR,lG,lB,Float.MAX_VALUE);
        m_fMass=Float.MAX_VALUE;
        m_fMomentOfInertia=Float.MAX_VALUE;        
        m_bImmobile=true;
        init();        
