...
public class CPlatform {
    ...
    public CPlatform(PhysEngRunnableGameCanvas pPhysEngRunnableGameCanvas,CScene pScene,CStage pStage){
        m_pStage=pStage;
        m_pScene=pScene;
    ...
    public void putPlatformInRandomPlace(){
    ...
    public void putPlatform(float x, float y)
    {
        if(CONSTANTS.POLYGON==m_pObject.getType()){
            CPolygon pPolygon1=(CPolygon)m_pObject;
    ...
    public void destroyThisPlatform(){
        m_bDestroyed=true;
